...
namespace FitnessApp.Repositories
{
    public class ProgressRepository : BaseRepository, IProgressRepository
    {
        ...
        public Progress GetLatestByExerciseId(int id)
        {
            using (var conn = Connection)
            {
                conn.Open();
